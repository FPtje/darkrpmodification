include("autorun/server/aaa_sql.lua")
...
RP_MySQLConfig.Host = DBConfig.host -- This is the IP address of the MySQL host. Make sure the IP address is correct and in quotation marks (" ")
RP_MySQLConfig.Username = DBConfig.username -- This is the username to log in on the MySQL server.
                                -- contact the owner of the server about the username and password. Make sure it's in quotation marks! (" ")
RP_MySQLConfig.Password = DBConfig.password -- This is the Password to log in on the MySQL server,
...
RP_MySQLConfig.Database_name = DBConfig.database -- This is the name of the Database on the MySQL server. Contact the MySQL server host to find out what this is
RP_MySQLConfig.Database_port = DBConfig.port -- This is the port of the MySQL server. Again, contact the MySQL server host if you don't know this.
